    ...
    <div className="overflow-hidden flex-grow relative">
      <div ref={msgRef} onScroll={onScroll} className="chats-scroll-div hide-scrollbar h-full max-w-full overflow-x-hidden overflow-y-scroll">
                ...
                <div className="flex  relative -bottom-2 -right-2 gap-1 self-end whitespace-nowrap items-center">
                  ...
                  <button
                    onClick={() => {
                      onMsgTag({
                        ...msg,
                        uname: msg.from === currentUser.uid ? currentUser.uname || "you" : selectedUser.uname,
                      });
        ...
        <div className="absolute bottom-0 w-11/12">
          ...
          >
            <div className={"absolute rounded-md text-gray-800 bottom-0 py-2 px-4 w-full bg-opacity-70 bg-blue-300 border-l-4 border-l-blue-600 transition-transform "}>
