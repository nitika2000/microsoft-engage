            ...
            return (
              ...
              >
                    ...
                    {isClassroom && msg.from === selectedUser.uid ? (
                      msg.pollObj ? (
                        <>
                          ...
                          {msg.pollObj.poll.map((obj, index) => {
                            return (
                              <div
                                key={index}
                                className="flex flex-row justify-between p-1 my-1 rounded-md bg-blue-50 "
                              >
                ...
                <div className="flex  relative -bottom-2 -right-2 gap-1 self-end whitespace-nowrap items-center">
                  ...
                  {msg.from === currentUser.uid ? (
                    msg.unread ? (
                      <span className="material-icons bottom-0 right-1 text-base ">
                        done
                      </span>
                    ) : (
                      <span className="text-base material-icons text-blue-600">
                        done_all
                      </span>
                    )
                  ) : null}
                  ...
                  >
                    <span className="text-gray-600 text-sm material-icons">
                      reply
                    </span>
                  </button>
                </div>
